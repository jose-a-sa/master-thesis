...
\pagestyle{empty}
\setcounter{page}{0}
\includepdf[page={1},pagecommand={},scale=1]{Cover/Front}
\cleardoublepage
...
\begin{abstract}
	In this work we study the phenomena of superradiance in the context of General Relativity, with particular focus on scattering of electromagnetic waves by rotating black hole.
	...
	This equation is both solved using approximate analytical methods and numerical techniques that are presented in detail.
...
%\nocite{*}
\bibliography{../bib-files/superradiance.bib}
